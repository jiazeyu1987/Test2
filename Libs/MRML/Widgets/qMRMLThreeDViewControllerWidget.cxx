...
void qMRMLThreeDViewControllerWidgetPrivate::init()
{
  ...
  this->CenterToolButton->setFixedSize(24, 24);
  ...
  JMarkButton->setObjectName("JMarkButton1");
  ...
  this->BarLayout->insertWidget(3,JMarkButton);
...
void qMRMLThreeDViewControllerWidget::setMarkerVisible(bool visible) {
    if (visible) {
