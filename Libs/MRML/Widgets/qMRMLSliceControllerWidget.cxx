...
//#endif
  ...
  QObject::connect(this->actionOrientationMarkerTypeHuman, SIGNAL(toggled(bool)),
      q, SLOT(setMarkerVisible(bool)));
...
void qMRMLSliceControllerWidgetPrivate::init()
{
  ...
  this->FitToWindowToolButton->setFixedSize(24, 24);
  ...
  SliceOffsetSlider->setSpinBoxVisible(false);
  

  auto JButton3DSlice = new QToolButton(q);
  JButton3DSlice->setObjectName("JButton3DSlice");
  JButton3DSlice->setCheckable(true);
  JButton3DSlice->setFixedSize(24, 24);
  JButton3DSlice->setDefaultAction(this->actionShow_in_3D);

  auto JMarkButton = new QToolButton(q);
  JMarkButton->setObjectName("JMarkButton");
  JMarkButton->setCheckable(true);
  JMarkButton->setFixedSize(24, 24);
  JMarkButton->setCheckable(true);
  JMarkButton->setDefaultAction(this->actionOrientationMarkerTypeHuman);

  SliceOffsetSlider->setFixedHeight(24);
  this->BarLayout->addWidget(JButton3DSlice);
  this->BarLayout->addWidget(JMarkButton);
...
void qMRMLSliceControllerWidget::setMarkerVisible(bool visible) {
    if (visible) {
        setOrientationMarkerType(2);
        setOrientationMarkerSize(1);
    }
    else {
        setOrientationMarkerType(false);
    }
}
