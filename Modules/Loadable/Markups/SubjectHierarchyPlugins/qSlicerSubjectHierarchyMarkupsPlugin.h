...
protected slots:
  ...
  void toggleHideLabelInteractive();

  void toggleChangeColorInteractive();

  void toggleChangeCameraDirectionInteractive();

  void toggleSliceProjectionInteractive();

  void toggleCommonSettingInteractive();

  void toggleResampleInteractive();
protected:
  QScopedPointer<qSlicerSubjectHierarchyMarkupsPluginPrivate> d_ptr;
  void on_rotate_to_vector(double* m_PointInput, double* m_PointTarget);
private:
