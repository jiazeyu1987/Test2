...
public:
  ...
  Q_INVOKABLE void registerModules();
  ...
  Q_INVOKABLE void pyAddSearchPath(const QString& path);
  ...
  Q_INVOKABLE virtual void instantiateModules();
